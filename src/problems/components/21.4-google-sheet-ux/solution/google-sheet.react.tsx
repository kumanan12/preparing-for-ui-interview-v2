...
import { type CellId, isCellReference } from '../../21.1-google-sheet-parser/solution/parser'
import { TableEngine } from '../../21.3-google-sheet-engine/solution/table-engine'
export const COLS = [
  'A',
  'B',
  'C',
